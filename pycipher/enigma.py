...
class Enigma(Cipher):
    ...
    def decipher(self, string):
        """Decipher string using Enigma M3 cipher according to initialised key. Punctuation and
        whitespace are removed from the input. The encipher and decipher operations of the Enigma
        are identical.
    ...
    def encipher(self,string):
        """Encipher string using Enigma M3 cipher according to initialised key. Punctuation and
