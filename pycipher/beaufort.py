...
class Beaufort(Cipher):
    """The Beaufort Cipher is similar to the Vigenere Cipher,
    and has a key consisting of a word e.g. 'FORTIFICATION'.
    This cipher encrypts a letter according to the Vigenere tableau,
    but uses a different algorithm to find the ciphertext letter.
    ...
    def decipher(self, string):
        """Decipher string using Beaufort cipher according to initialised key. Punctuation and
        whitespace are removed from the input. For the Beaufort cipher, enciphering and deciphering
