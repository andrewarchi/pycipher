...
####################################################################################
class Bifid(Cipher):
    """The Bifid Cipher is a fractionating cipher, and has a key consisting of a 25 letter
    keysquare (with a letter removed e.g. 'J'), along with a 'period', which is an integer.
    ...
    def encipher(self, string):
        """Encipher string using Bifid cipher according to initialised key. Punctuation and
    ...
    def decipher(self, string):
        """Decipher string using Bifid cipher according to initialised key. Punctuation and
        whitespace are removed from the input.
