...
class Playfair(Cipher):
    """The Playfair Cipher enciphers pairs of characters, the key consists of a keysquare 25
    characters in length. More information about the algorithm can be found at
    http://www.practicalcryptography.com/ciphers/playfair-cipher/.
    ...
    def encipher(self, string):
        """Encipher string using Playfair cipher according to initialised key. Punctuation and
    ...
    def decipher(self, string):
        """Decipher string using Playfair cipher according to initialised key. Punctuation and
