...
class ColTrans(Cipher):
    """The Columnar Transposition Cipher is a fractionating cipher, and has a key consisting of a
    word e.g. 'GERMAN'. For more information, the algorithm can be seen e.g.
    ...
    def encipher(self, string):
        """Encipher string using Columnar Transposition cipher according to initialised key. Punctuation and
    ...
    def decipher(self, string):
        '''Decipher string using Columnar Transposition cipher according to initialised key. Punctuation and
        whitespace are removed from the input.
